...
-   Source selection:
    ...
    -   As the German Federal Statistical Office, Destatis is a reputable source that is independent and non-commercial.
...
-   **Images:**
    ...
    -   The images illustrate the [[content:\\\\](content:\\){.uri}]([content:\\](content:\){.uri}){.uri} The hourglass is used to visually highlight the theme of remaining lifetime.\
...
*Apart from this important point, the reasoning is generally the same as for the plot above.*
